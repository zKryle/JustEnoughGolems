...
public class Init{
    ...
    public static RegistryObject <Block> MAGMATIC_OBSIDIAN = BLOCKS.register( "magmatic_obsidian" ,
            () -> new MagmaticObsidianBlock( AbstractBlock.Properties.copy( Blocks.CRYING_OBSIDIAN )));
    ...
    public static RegistryObject <Block> CHARGING_TABLE = BLOCKS.register( "charging_table" ,
            () -> new ChargingTableBlock( AbstractBlock.Properties.copy(Blocks.OBSIDIAN) ) );


    // _-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_- MOD TILE ENTITIES -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
    public static DeferredRegister <TileEntityType<?>> TILE_ENTITY_TYPES = DeferredRegister.create( ForgeRegistries.TILE_ENTITIES , JustEnoughGolems.MOD_ID );

    public static final RegistryObject < TileEntityType <ChargingTableTileEntity> > CHARGING_TABLE_TILE_ENTITY_TYPE = TILE_ENTITY_TYPES
            .register("charging_table", () -> TileEntityType.Builder.of( ChargingTableTileEntity::new,
    ...
    public static RegistryObject <BlockItem> PRECIOUS_MOSSY_COBBLESTONE_ITEM = ITEMS.register( "precious_mossy_cobblestone" ,
            () -> new BlockItem( PRECIOUS_MOSSY_COBBLESTONE.get() ,
                    new Item.Properties().tab( ItemGroup.TAB_BUILDING_BLOCKS ).tab( JEG_ITEM_GROUP ) ) );

    public static RegistryObject <BlockItem> MOSSY_OBSERVER_ITEM = ITEMS.register( "mossy_observer" ,
            () -> new BlockItem( MOSSY_OBSERVER.get() ,
                    new Item.Properties().tab( ItemGroup.TAB_REDSTONE ).tab( JEG_ITEM_GROUP )  ) );
    ...
    public static RegistryObject <BlockItem> MAGMATIC_OBSIDIAN_ITEM = ITEMS.register( "magmatic_obsidian" ,
            () -> new BlockItem( MAGMATIC_OBSIDIAN.get() ,
                    new Item.Properties().fireResistant().tab( ItemGroup.TAB_BUILDING_BLOCKS ).tab( JEG_ITEM_GROUP )  ) );

    public static RegistryObject <BlockItem> CHARGING_TABLE_ITEM = ITEMS.register( "charging_table" ,
            () -> new BlockItem( CHARGING_TABLE.get() ,
                    new Item.Properties().fireResistant().tab( ItemGroup.TAB_MISC ).tab( JEG_ITEM_GROUP )  ) );

    public static RegistryObject <Item> MAGMATIC_OBSIDIAN_SHARD_ITEM = ITEMS.register( "magmatic_obsidian_shard" ,
            () -> new Item( new Item.Properties().fireResistant().tab( ItemGroup.TAB_MISC ).tab( JEG_ITEM_GROUP ) ) );

    public static RegistryObject <Item> MAGMATIC_CHARM_ITEM = ITEMS.register( "magmatic_charm" ,
            () -> new MagmaticCharm( new Item.Properties().fireResistant().stacksTo( 1 ).tab( ItemGroup.TAB_MISC ).tab( JEG_ITEM_GROUP ) ) );

    public static RegistryObject <Item> MAGMATIC_PENDANT_ITEM = ITEMS.register( "magmatic_pendant" ,
            () -> new Item( new Item.Properties().fireResistant().stacksTo( 1 ).tab( ItemGroup.TAB_MISC ).tab( JEG_ITEM_GROUP ) ) );


    public static RegistryObject <Item> NETHER_CORE_ITEM = ITEMS.register( "nether_core" ,
            () -> new Item( new Item.Properties().fireResistant().stacksTo( 1 ).tab( ItemGroup.TAB_MISC ).tab( JEG_ITEM_GROUP ) .durability( 1000 ) ) );
